...
export function buildEmbeddingTexts(): Array<{ id: string; text: string }> {
  ...
  const skillContextMap: Record<string, string> = {
    ...
    'dashboard-dev': 'Built Power BI dashboards tracking £215M prescribing budget, DOAC switching scenario models, and self-serve analytics tools used across Norfolk & Waveney ICB.',
    ...
    'formulary-commissioning': 'High-cost drug formulary management, Blueteq prior authorisation, tirzepatide commissioning with primary care delivery model, and system-wide formulary governance.',
    ...
    'healthcare-leadership': 'NHS Mary Seacole Leadership Programme graduate. ICS-level strategic leadership from HCD Pharmacist through to Interim Head of Population Health with CMO reporting line.',
  }
